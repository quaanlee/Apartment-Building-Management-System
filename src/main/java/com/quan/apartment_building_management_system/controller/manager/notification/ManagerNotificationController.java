package com.quan.apartment_building_management_system.controller.manager.notification;
...
public class ManagerNotificationController {
    ...
    public String editNotification(@PathVariable Long id, 
        ...
        com.quan.apartment_building_management_system.dto.systemlog.NotificationLogDTO oldDto = com.quan.apartment_building_management_system.dto.systemlog.NotificationLogDTO.fromEntity(notification);
        ...
        com.quan.apartment_building_management_system.dto.systemlog.NotificationLogDTO newDto = com.quan.apartment_building_management_system.dto.systemlog.NotificationLogDTO.fromEntity(notification);
        Integer entityId = notification.getNotificationId() != null ? notification.getNotificationId().intValue() : null;
        systemLogService.logSystemAction("UPDATE_NOTIFICATION", "Notification", entityId, oldDto, newDto, "Updated notification: " + notification.getTitle());
    ...
    public String deleteNotification(@PathVariable Long id, RedirectAttributes redirectAttributes) {
        ...
        Notification notification = notificationOpt.get();
        com.quan.apartment_building_management_system.dto.systemlog.NotificationLogDTO oldDto =
                com.quan.apartment_building_management_system.dto.systemlog.NotificationLogDTO.fromEntity(notification);
        Integer entityId = notification.getNotificationId() != null ? notification.getNotificationId().intValue() : null;

        notificationService.deleteById(id);

        systemLogService.logSystemAction("DELETE_NOTIFICATION", "Notification", entityId, oldDto,
                new com.quan.apartment_building_management_system.dto.systemlog.NotificationLogDTO(),
    ...
    public String createNotification(
        ...
        com.quan.apartment_building_management_system.dto.systemlog.NotificationLogDTO newDto = com.quan.apartment_building_management_system.dto.systemlog.NotificationLogDTO.fromEntity(notification);
        Integer entityId = notification.getNotificationId() != null ? notification.getNotificationId().intValue() : null;
        systemLogService.logSystemAction("CREATE_NOTIFICATION", "Notification", entityId, null, newDto, "Created notification: " + notification.getTitle());
