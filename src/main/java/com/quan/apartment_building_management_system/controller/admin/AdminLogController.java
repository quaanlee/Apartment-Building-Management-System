...
public class AdminLogController {
    ...
    static {
        ...
        ACTION_MAP.put("LOGOUT", "Đăng xuất");
        ...
        ACTION_MAP.put("ADD_RESIDENT", "Thêm cư dân vào phòng");
        ACTION_MAP.put("UPDATE_RESIDENT_APARTMENT", "Cập nhật cư dân trong phòng");
        ACTION_MAP.put("CREATE_SERVICE", "Tạo dịch vụ");
        ACTION_MAP.put("UPDATE_SERVICE", "Cập nhật dịch vụ");
        ACTION_MAP.put("TOGGLE_SERVICE_STATUS", "Thay đổi trạng thái dịch vụ");
        ACTION_MAP.put("CREATE_UTILITY", "Tạo tiện ích");
        ACTION_MAP.put("UPDATE_UTILITY", "Cập nhật tiện ích");
        ACTION_MAP.put("TOGGLE_UTILITY_STATUS", "Thay đổi trạng thái tiện ích");
        ACTION_MAP.put("CREATE_UTILITY_RESOURCE", "Tạo tài nguyên tiện ích");
        ACTION_MAP.put("UPDATE_UTILITY_RESOURCE", "Cập nhật tài nguyên tiện ích");
        ACTION_MAP.put("TOGGLE_UTILITY_RESOURCE_STATUS", "Thay đổi trạng thái tài nguyên tiện ích");
        ACTION_MAP.put("CREATE_UTILITY_PRICE", "Tạo đơn giá tiện ích");
        ACTION_MAP.put("UPDATE_UTILITY_PRICE", "Cập nhật đơn giá tiện ích");
        ACTION_MAP.put("CREATE_UTILITY_BOOKING", "Tạo đơn đặt tiện ích");
        ACTION_MAP.put("UPDATE_UTILITY_BOOKING", "Cập nhật đơn đặt tiện ích");
        ACTION_MAP.put("UPDATE_BOOKING_STATUS", "Cập nhật trạng thái đặt tiện ích");
        ACTION_MAP.put("CANCEL_BOOKING", "Hủy đặt tiện ích");
        ACTION_MAP.put("DELETE_BOOKING", "Xóa đặt tiện ích");
        ACTION_MAP.put("CREATE_BILL", "Tạo hóa đơn");
        ACTION_MAP.put("UPDATE_BILL", "Cập nhật hóa đơn");
        ACTION_MAP.put("UPDATE_BILL_STATUS", "Cập nhật trạng thái hóa đơn");
        ...
        ACTION_MAP.put("ASSIGN_MAINTENANCE_TASK", "Giao việc bảo trì");
        ACTION_MAP.put("UPDATE_MAINTENANCE_TASK", "Cập nhật nhiệm vụ bảo trì");
        ...
        ACTION_MAP.put("UPDATE_PERMISSIONS", "Cập nhật quyền");
        ACTION_MAP.put("DAILY_BACKUP", "Sao lưu hàng ngày");
